...
class TES(nn.Module):
    ...
    def forward(self,x,drop_or_not=False,ifget=False):
        # [bs,512]
        img_feasts = self.vlm_model.encode_image(x,ifget=ifget).float()
        # [bs,7,512]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--top_m_ratio', default=0.33,type=float)
